...
public class MBTI{
	...
	private static String[] response = new String[20];
	...
	public static void askQuestionTakeAnswer() throws InputMismatchException {
	...
	public static void dectectPersonality(){
